...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --enable-gpl --enable-version3 --enable-x11grab --enable-libfaac --enable-libfreetype --enable-libmp3lame --enable-libtheora --enable-libx264 --enable-libxvid --enable-libopenjpeg --enable-muxer=alsa --enable-demuxer=alsa --enable-avfilter --enable-nonfree --enable-librtmp --enable-libvorbis --enable-pthreads --enable-shmgrab
prefix=/usr/local
...
SRC_PATH="/home/caioviel/git/libffmpeg-c/deps/ffmpeg"
SRC_PATH_BARE=/home/caioviel/git/libffmpeg-c/deps/ffmpeg
...
EXTRALIBS=-ldl -lX11 -lXext -lXfixes -lasound -lxvidcore -lx264 -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lrtmp -lz -lgnutls -lopenjpeg -lmp3lame -lfreetype -lfaac -lm -pthread -lz 
INSTALL=install
LIBTARGET=
...
CONFIG_SHM_GRAB_DEVICE_INDEV=yes

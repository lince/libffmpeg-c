...
#define FFMPEG_CONFIGURATION "--enable-shared --enable-gpl --enable-version3 --enable-x11grab --enable-libfaac --enable-libfreetype --enable-libmp3lame --enable-libtheora --enable-libx264 --enable-libxvid --enable-libopenjpeg --enable-muxer=alsa --enable-demuxer=alsa --enable-avfilter --enable-nonfree --enable-librtmp --enable-libvorbis --enable-pthreads --enable-shmgrab"

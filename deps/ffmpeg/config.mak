...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --enable-gpl --enable-version3 --enable-x11grab --enable-libfaac --enable-libfreetype --enable-libmp3lame --enable-libtheora --enable-libx264 --enable-libxvid --enable-libopenjpeg --enable-muxer=alsa --enable-demuxer=alsa --enable-avfilter --enable-nonfree
prefix=/usr/local
...
EXTRALIBS=-ldl -lX11 -lXext -lXfixes -lasound -lxvidcore -lx264 -ltheoraenc -ltheoradec -logg -lopenjpeg -lmp3lame -lfreetype -lfaac -lm -pthread -lz 
INSTALL=install
LIBTARGET=

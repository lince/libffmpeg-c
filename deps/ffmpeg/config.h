...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-version3 --enable-nonfree --enable-static --enable-postproc --enable-pthreads --enable-shared --enable-libfaac --enable-libtheora --enable-libx264 --enable-libxvid --enable-x11grab --enable-muxer=alsa --enable-demuxer=alsa --enable-avfilter --enable-libmp3lame --enable-shmgrab"
...
#define CONFIG_FBGRAB 0
#define CONFIG_SHMGRAB 1
...
#define CONFIG_FB_GRAB_DEVICE_INDEV 0
#define CONFIG_SHM_GRAB_DEVICE_INDEV 1
